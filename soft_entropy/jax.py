...
def soft_entropy(z: jax.Array, n_bins: int = 100, seed: int = 0, calibration: str = "find_eps") -> jax.Array:
    """
...
def soft_mutual_information(z: jax.Array, labels: jax.Array, n_bins: int = 100, seed: int = 0, calibration: str = "find_eps") -> jax.Array:
    """
